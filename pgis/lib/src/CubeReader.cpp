...
void metacg::pgis::build(std::string filepath, Config *c, metacg::graph::MCGManager &mcgm) {
  impl::build(filepath, mcgm, impl::attRuntime);
}

void metacg::pgis::buildFromCube(std::string filePath, Config *c, metacg::graph::MCGManager &mcgm) {
