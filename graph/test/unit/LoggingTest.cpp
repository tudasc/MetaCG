...
TEST_F(LoggingTest, InfoConsoleUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStdout();
  logger.info<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  logger.info<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStdout();
  removeDate(output);
  ASSERT_EQ(output, "[console] [info] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, InfoErrorDefault) {
  ...
  logger.info<metacg::MCGLogger::LogType::DEFAULT, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
...
TEST_F(LoggingTest, InfoErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.info<metacg::MCGLogger::LogType::UNIQUE,metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.info<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
  ASSERT_EQ(output, "[errconsole] [info] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, DebugConsoleUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStdout();
  logger.debug<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  logger.debug<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStdout();
  removeDate(output);
  ASSERT_EQ(output, "[console] [debug] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, DebugErrorDefault) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.debug<metacg::MCGLogger::LogType::DEFAULT, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
...
TEST_F(LoggingTest, DebugErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.debug<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.debug<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
  ASSERT_EQ(output, "[errconsole] [debug] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, WarnConsoleUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStdout();
  logger.warn<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  logger.warn<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStdout();
  removeDate(output);
  ASSERT_EQ(output, "[console] [warning] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, WarnErrorDefault) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.warn<metacg::MCGLogger::LogType::DEFAULT, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
...
TEST_F(LoggingTest, WarnErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.warn<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.warn< metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
  ASSERT_EQ(output, "[errconsole] [warning] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, ErrorConsoleUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStdout();
  logger.error<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  logger.error< metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStdout();
  removeDate(output);
  ASSERT_EQ(output, "[console] [error] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, ErrorErrorDefault) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.error<metacg::MCGLogger::LogType::DEFAULT, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
...
TEST_F(LoggingTest, ErrorErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.error<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.error<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
  ASSERT_EQ(output, "[errconsole] [error] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, TraceConsoleUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStdout();
  logger.trace<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  logger.trace<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStdout();
  removeDate(output);
  ASSERT_EQ(output, "[console] [trace] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, TraceErrorDefault) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.trace<metacg::MCGLogger::LogType::DEFAULT, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
...
TEST_F(LoggingTest, TraceErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.trace<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.trace<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1, 2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
  ASSERT_EQ(output, "[errconsole] [trace] Test String 1, 2.3 \n");
...
TEST_F(LoggingTest, CriticalErrorUnique) {
  auto logger = metacg::MCGLogger::instance();
  testing::internal::CaptureStderr();
  logger.critical<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::ErrConsole>("Test String {}, {} ", 1, 2.3f);
  logger.critical<metacg::MCGLogger::LogType::UNIQUE, metacg::MCGLogger::Output::StdConsole>("Test String {}, {} ", 1,
                                                                                          2.3f);
  std::string output = testing::internal::GetCapturedStderr();
  removeDate(output);
