...
function(add_pgis_includes target)
    target_include_directories(${target}
            PUBLIC
            $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}/pgis/lib/include>
            )
endfunction()
...
function(add_graph_includes target)
    ...
    target_include_directories(${target}
            PUBLIC
            $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}/graph/include>
            )
endfunction()
...
function(add_mcg_includes target)
    target_include_directories(${target}
            PUBLIC
            $<BUILD_INTERFACE:${PROJECT_SOURCE_DIR}/pgis/lib/include/libIPCG>
            )
endfunction()
