...
void generateUSRForCallOrConstructExpr(const Expr* CE, const clang::ASTContext* Context, SmallVectorImpl<char>& Buf,
...
StringType generateUSRForCallOrConstructExpr(const Expr* CE, const clang::ASTContext* Context,
                                             clang::FunctionDecl* ParentFunctionDecl) {
