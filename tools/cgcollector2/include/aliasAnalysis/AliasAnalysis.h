...
class ASTInformationExtractor : public clang::RecursiveASTVisitor<ASTInformationExtractor> {
 public:
  ASTInformationExtractor(const clang::ASTContext* CTX, metacg::Callgraph* CG, bool CaptureCtorsDtors,
...
template <>
struct std::hash<CallInfoConstIterType> {
  std::size_t operator()(CallInfoConstIterType O) const noexcept {
